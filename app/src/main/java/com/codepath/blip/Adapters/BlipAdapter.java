...
public class BlipAdapter extends RecyclerView.Adapter<BlipAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ImageView blipImage = holder.image;
        ...
        textUpVotes.setText(blip.getUpvotes());
        if (blip.getPictureUrl() == null) {
            blipImage.setVisibility(View.GONE);
        } else {
            Picasso.with(mContext).load(blip.getPictureUrl()).fit().into(blipImage);
        }
